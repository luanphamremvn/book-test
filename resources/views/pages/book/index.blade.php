...
<div class="relative overflow-x-auto">
    <table class="sm:w-full w-lg text-left rtl:text-right text-gray-500 overflow-x-auto">
        ...
        <tbody>
            @if ($books instanceof Illuminate\Pagination\LengthAwarePaginator && count($books) > 0)
            ...
            <tr class="bg-white border-b  border-gray-200">
                ...
                <td class="px-3 py-4 lg:max-w-3xs w-full break-words">
                    {{ $book->shortDescription }}
                </td>
                <td class="px-3 py-4 min-w-48">
                    <a type="button" href="{{ route('books.show', ['book' => $book->book_id]) }}"
                        class="border-[0.5px] p-2 rounded-sm cursor-pointer text-white bg-blue-500 min-w-[60px] mr-1">
                        Chỉnh sửa
                    </a>
                    <a href="#" onClick="deleteBook({{ $book->book_id }})" type="button"
