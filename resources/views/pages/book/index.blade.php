            ...
            <div class="w-full flex flex-row h-auto">
                <div class="flex flex-row w-full">
                    ...
                    <div id="dropdown"
                        ...
                        <ul class="py-2 text-sm text-gray-700 overflow-x-auto" aria-labelledby="dropdown-button">
                            @foreach ($categories as $category)
                            <li>
                                <button type="button" for="categories"
                                    class="inline-flex w-full items-center p-2 hover:bg-gray-100 :hover:bg-gray-600">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b  border-gray-200">
                <th scope="row" class="px-4 py-4">
                    <img src="{{ $item->imageUrl }}" class="sm:w-40 sm:h-28 max-w-32 h-20" loading="lazy" />
                </th>
                <th class="px-6 py-4">
                    {{ $item->name }}
                </th>
                ...
                <td class="px-3 py-4 lg:max-w-3xs break-words">
